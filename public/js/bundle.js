...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoidGhlZHVkZTk5IiwiYSI6ImNrZGU2dGxmNzJlOTcycHNjNWxnaXNkdjgifQ.YSwJZlZ22gLWYuOR75pZzQ";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            // setting reload to true to force reload from the server to get a fresh page from the server
...
var stripe = Stripe("pk_test_51HDmBHGTdcJEqUCbNcTsEsnZGpHfu9riQmsm8tvrQ0H0wkZYK7YkPL7sybXwDszDgTLqu9ajP1kVChSCcLe89goY00jQlyALEf");
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector(".btn--save-password").textContent = "Save password"; // Clearing the values of the updated fields
